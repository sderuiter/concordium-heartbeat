...
if file_exists:
    from envdonotcommit import (MONGODB_PASSWORD_LOCAL, API_TOKEN_LOCAL, MONGO_IP_LOCAL, 
    MONGO_PORT_LOCAL,NOTIFIER_API_TOKEN_LOCAL, FASTMAIL_TOKEN_LOCAL, REQUESTOR_NODES_LOCAL,
    TESTNET_IP_LOCAL, MAINNET_IP_LOCAL, TESTNET_PORT_LOCAL, MAINNET_PORT_LOCAL, NET_LOCAL)
...
MAX_BLOCKS_PER_RUN = os.environ.get('MAX_BLOCKS_PER_RUN', 1000)   
